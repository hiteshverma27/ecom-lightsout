    ...
    <main>
      <div className="filter my-2">
        ...
        <div className="p-2 test-outline">
          <h3>Price</h3>
          <input
            className="my-2 w-100per"
            type="range"
            min="0"
            max="10000"
            value={filterState.inputPrice}
            onChange={(e) =>
              filterDispatch({
                type: "INPUT_PRICE",
          ...
          <form className="my-2">
            <label>
              <input
                ...
                onChange={() =>
                  filterDispatch({ type: "CATEGORY_NAME", payload: "poster" })
                }
              />
              Poster
            </label>
            ...
            <label>
              <input
                ...
                onChange={() =>
                  filterDispatch({ type: "CATEGORY_NAME", payload: "flag" })
                }
              />
              Flag
            </label>
            ...
            <label>
              <input
                ...
                onChange={() =>
                  filterDispatch({ type: "CATEGORY_NAME", payload: "wearable" })
                }
              />
              Wearable
            </label>
          ...
          <form>
            <label>
              <input
                ...
                name="option2"
                onChange={() =>
                  filterDispatch({ type: "INPUT_SORT", payload: "HIGH_TO_LOW" })
                }
              />
              High to low
            </label>
            ...
            <label>
              <input
                ...
                name="option2"
                onChange={() =>
                  filterDispatch({ type: "INPUT_SORT", payload: "LOW_TO_HIGH" })
                }
              />
              Low to high
            </label>
